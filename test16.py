...
class TeacherManager(QMainWindow):
    def __init__(self):
       ...
       # تنظیم تایمر
        ...
        self.attendance_table.setHorizontalHeaderLabels(["زمان", "کد", "نام", "کلاس", "روز", "وضعیت"])
